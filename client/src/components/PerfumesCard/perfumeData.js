...
export const menInformation = [
    {
        title: "As a Modern Gentleman, Know How to Choose a Bottle of Men's Perfume.",
        contents: [
            'Let the scent of perfume help you tell the world what kind of man you are.',
            'It is no longer rare for men to use perfume. This is almost an easy and popular way for men to show their masculinity. There have been many studies showing that women feel that men are more masculine when they use perfume.',
            'Perfume is a powerful weapon for men. Make yourself more masculine, stronger, luxurious, and classy than ever. Nothing big is needed, just a scent that will make someone admire when passing by.',
            "Coming to Tomtoc Perfumes & Cosmetics, you can freely search and experience many genuine, high-end, and popular men's perfume brands.",
        ],
    },
];
...
export const womenInformation = [
    {
        title: 'Women Are Like Flowers, And If You Are A Flower, You Must Spread Fragrance.',
        contents: [
            'Clothes, high heels and a lipstick help women to be well-groomed in appearance. And a bottle of perfume will make women become confident, attractive and charming.',

            'Perfume is the most splendid jewelry that every girl should have. Just a lingering scent on the skin, clothes and hair will implicitly affirm who you are. Become a "classy" woman by choosing a suitable bottle of women\'s perfume.',

            'Coming to Tomtoc Perfumes, you can freely search and experience many famous brands, from high-end to popular.',
        ],
    },
];
